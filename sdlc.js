...
const Design = "the steps a coder should follow when programming in a certain languge."
const TestingIntergration = "a type of software testing in which the different units, modules or components of a software application are tested as a combined entity."
const Maintain = "to find new variations of the things youve used to improve your code"
const Analysis = "the process of determining user expectations for a new or modified product"
const Implementation = "the notcing of an algorithim in a devlopment"